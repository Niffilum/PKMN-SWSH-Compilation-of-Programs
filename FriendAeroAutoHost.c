...
static const Command autoHost[] = {
	...
	{Y, 50},
	{PLUS, 700},		// Internet connection time (400 ~= 9 seconds wait)
	{B, 1},
	{NOTHING, 6}, 
	...
	{NOTHING, 1},
	{A, 1},				
	{NOTHING, 500},	// Wait until game starting showing abilities (if any has one)
	
	//----------Finish/Prepare SR [24,63]----------
	{HOME, 40},		// brings out side menu
	{NOTHING, 1},
	{DOWN, 30},		//hovers in airplane mode
	{A, 5},			
	{NOTHING, 20},
	{A, 5},			// turns AM on and off immediately
	{NOTHING, 20},
	{B, 5},			
	{NOTHING, 20},
	{B, 25},		// Closes side menu and Server disconnected prompt
	{B, 10},
	{NOTHING, 150}, // Waits for a while before looping
	// add friend [36,63]
	{HOME, 1},      {NOTHING, 15},
	{UP, 1},        {NOTHING, 55},
	{A, 5},         {NOTHING, 155},
	...
	if (commandIndex == -1)
	{
		...
		else //if (m_sequence <= 13)
		{
			...
			if (m_sequence % 3 == 0) // 3,6,9,12
			{
				...
				{
					commandIndex = 73 + (number / 3) * 2;
					m_endIndex = (number % 3 == 1) ? 80 : 78;
				}
			}
