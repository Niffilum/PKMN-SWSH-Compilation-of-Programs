...
static const Command softlockHoster[] = {	
	...
	// y-comm
	{Y,        5},  {NOTHING,   50}, 
	{PLUS,     5},	{NOTHING,  600}, // 45 = 1 second
	{B,        5},  {NOTHING,   10}, 
	{B,        5},	{NOTHING,   30}, 
	{B,        5},  {NOTHING,  175}, 
	...
	// start game
	{A,        1},	{NOTHING,   50}, // select game
	{A,        1},	{NOTHING,  720}, // pick user
	{BACKUP,   1},	{NOTHING,  100}, // load backup save
	{A,        1},	{NOTHING,   50}, 
	{A,        1},	{NOTHING,  460}, 
