...
static const Command autoHost[] = {
	...
	{Y, 50},
	{PLUS, 650},		// Internet connection time (400 ~= 9 seconds wait)
	{B, 1},
	{NOTHING, 6}, 
	...
	{B, 10},
	{NOTHING, 620}, // Waits for a while before looping
	...
	if (commandIndex == -1)
	{
		...
		else //if (m_sequence <= 13)
		{
			...
			if (m_sequence % 3 == 0) // 3,6,9,12
			{
				...
				{
					commandIndex = 53 + (number / 3 - 1) * 2;
					m_endIndex = 60;
				}
				else // 1,4,7,2,5,8
				{
					commandIndex = 45 + (number / 3) * 2;
